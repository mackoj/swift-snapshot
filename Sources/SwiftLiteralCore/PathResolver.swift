...
/// 1. `outputBasePath` parameter from ``Literal/export(instance:variableName:file:directory:allowOverwrite:header:context:testName:line:fileID:filePath:)``
...
/// let url2 = try Literal.export(
///     instance: user,
///     variableName: "adminUser",
///     directory: "/path/to/fixtures"
/// )
/// // Output: /path/to/fixtures/User+adminUser.swift
/// ```
///
/// ## See Also
/// - ``LiteralConfig`` for global directory configuration
/// - ``Literal`` for the main export API
enum PathResolver {
  ...
  ///   - file: Optional custom file name (with or without `.swift` extension)
