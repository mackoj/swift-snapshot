...
Learn how to use SwiftLiteral to generate type-safe Swift fixtures from runtime values.
...
// Integer
let count = 42
Literal.export(instance: count, variableName: "testCount")
// Generates: extension Int { static let testCount: Int = 42 }

// String
let message = "Hello, World!"
Literal.export(instance: message, variableName: "greeting")
// Generates: extension String { static let greeting: String = "Hello, World!" }

// Boolean
let isEnabled = true
Literal.export(instance: isEnabled, variableName: "featureFlag")
...
Literal.export(instance: timestamp, variableName: "launchDate")
...
Literal.export(instance: identifier, variableName: "sessionId")
...
Literal.export(instance: endpoint, variableName: "apiEndpoint")
...
Literal.export(instance: numbers, variableName: "fibonacci")
// Generates: extension Array { static let fibonacci: Array<Int> = [1,2,3,4,5] }

let names = ["Alice", "Bob", "Charlie"]
Literal.export(instance: names, variableName: "teamMembers")
```
...
Literal.export(instance: config, variableName: "defaultConfig")
...
Literal.export(instance: tags, variableName: "supportedTags")
...
Literal.export(instance: user, variableName: "testUser")
// Generates:
// extension User {
...
Literal.export(instance: currentStatus, variableName: "userStatus")
...
Literal.export(instance: person, variableName: "testPerson")
// Generates:
// extension Person {
...
Configure SwiftLiteral behavior globally using ``LiteralConfig``:

```swift
// Set global output directory
LiteralConfig.setGlobalRoot(URL(fileURLWithPath: "/path/to/fixtures"))

// Set global header for all exports
LiteralConfig.setGlobalHeader("""
...
See ``LiteralConfig``, ``FormatProfile``, and ``RenderOptions`` for more details.
...
For types that need custom rendering logic, use ``ValueRendererRegistry``:
...
let url = Literal.export(instance: custom, variableName: "myCustom")
...
ValueRendererRegistry.register(HashedValue.self) { value, context in
    ExprSyntax(stringLiteral: "HashedValue(restoringHash: \(value.hash))")
}

let hashed = HashedValue(from: "secret")
let url = try hashed.writeLiteral(variableName: "myHashed")
