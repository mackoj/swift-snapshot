...
/// Global configuration for SwiftLiteral.
///
...
/// LiteralConfig.setGlobalHeader("// Auto-generated fixtures")
///
/// // Configure formatting from .editorconfig
/// let configURL = URL(fileURLWithPath: ".editorconfig")
/// LiteralConfig.setFormatConfigSource(.editorconfig(configURL))
/// ```
public enum LiteralConfig {
  ...
  public static func setGlobalRoot(_ url: URL?) {
    ...
    globalRoot = url
    #else
    reportIssue("LiteralConfig.setGlobalRoot() called in release build. Configuration methods should only be used in DEBUG builds.")
    #endif
  }
  ...
  public static func getGlobalRoot() -> URL? {
    ...
    return globalRoot
    #else
    reportIssue("LiteralConfig.getGlobalRoot() called in release build. Configuration methods should only be used in DEBUG builds.")
    return nil
    #endif
  }
  ...
  public static func setGlobalHeader(_ header: String?) {
    ...
    globalHeader = header
    #else
    reportIssue("LiteralConfig.setGlobalHeader() called in release build. Configuration methods should only be used in DEBUG builds.")
    #endif
  }
  ...
  public static func getGlobalHeader() -> String? {
    ...
    return globalHeader
    #else
    reportIssue("LiteralConfig.getGlobalHeader() called in release build. Configuration methods should only be used in DEBUG builds.")
    return nil
    #endif
  }
  ...
  public static func setFormattingProfile(_ profile: FormatProfile) {
    ...
    #else
    reportIssue("LiteralConfig.setFormattingProfile() called in release build. Configuration methods should only be used in DEBUG builds.")
    #endif
  }
  ...
  public static func formattingProfile() -> FormatProfile {
    ...
    #else
    reportIssue("LiteralConfig.formattingProfile() called in release build. Configuration methods should only be used in DEBUG builds.")
  ...
  public static func setRenderOptions(_ options: RenderOptions) {
    ...
    renderOpts = options
    #else
    reportIssue("LiteralConfig.setRenderOptions() called in release build. Configuration methods should only be used in DEBUG builds.")
    #endif
  }
  ...
  public static func renderOptions() -> RenderOptions {
    ...
    return renderOpts
    #else
    reportIssue("LiteralConfig.renderOptions() called in release build. Configuration methods should only be used in DEBUG builds.")
  ...
  public static func setFormatConfigSource(_ source: FormatConfigSource?) {
    ...
    #else
    reportIssue("LiteralConfig.setFormatConfigSource() called in release build. Configuration methods should only be used in DEBUG builds.")
    #endif
  }
  ...
  public static func getFormatConfigSource() -> FormatConfigSource? {
    ...
    #else
    reportIssue("LiteralConfig.getFormatConfigSource() called in release build. Configuration methods should only be used in DEBUG builds.")
    return nil
    #endif
  }
