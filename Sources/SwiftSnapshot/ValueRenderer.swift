...
enum ValueRenderer {
    ...
    static func renderDouble(_ value: Double) -> ExprSyntax {
        if value.isNaN {
            ...
            return ExprSyntax(FloatLiteralExprSyntax(floatingDigits: .floatLiteral(String(format: "%.15g", value))))
        }
    }
    ...
    static func renderOptional(_ value: any OptionalProtocol, context: SnapshotRenderContext) throws -> ExprSyntax {
    ...
    static func renderDictionary(_ dict: [AnyHashable: Any], context: SnapshotRenderContext) throws -> ExprSyntax {
        if dict.isEmpty {
    ...
    static func renderViaReflection(_ value: Any, context: SnapshotRenderContext) throws -> ExprSyntax {
        ...
        if mirror.displayStyle == .struct || mirror.displayStyle == .class {
            return try renderStructViaReflection(value, typeName: typeName, mirror: mirror, context: context)
        }
        
        throw SwiftSnapshotError.unsupportedType(typeName, path: context.path)
    }
    
    static func renderEnumViaReflection(_ value: Any, mirror: Mirror, context: SnapshotRenderContext) throws -> ExprSyntax {
    ...
    static func renderStructViaReflection(_ value: Any, typeName: String, mirror: Mirror, context: SnapshotRenderContext) throws -> ExprSyntax {
        var args: [String] = []
