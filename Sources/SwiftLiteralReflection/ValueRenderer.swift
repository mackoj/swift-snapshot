...
public enum ValueRenderer {
  ...
  ///
  /// - Throws: ``LiteralError/unsupportedType(_:path:)`` when nothing can read
  ///   the value, or ``LiteralError/reflection(_:path:)`` when the text it
  ///   produced does not parse.
  public static func render(_ value: Any, context: RenderContext = .init()) throws
    -> ExprSyntax
  {
  ...
  static func text(_ value: Any, context: RenderContext) throws -> String {
    ...
    if let exportable = value as? any LiteralFields,
  ...
  private static func foundationText(_ value: Any, context: RenderContext) throws -> String?
  {
    switch value {
    case let v as Date:
  ...
  private static func collectionText(_ value: Any, context: RenderContext) throws -> String?
  {
  ...
  private static func rangeText(_ value: Any, context: RenderContext) throws -> String? {
  ...
  private static func exportableText(
    _ exportable: any LiteralFields, context: RenderContext
  ) throws -> String? {
  ...
  /// types. It guessed wrong quietly. Now it says so. Mark them `@LiteralIgnore`, or
  /// register a custom renderer.
  private static func propertyWrapperValue(
    label: String, value: Any, context: RenderContext
  ) throws -> (String, Any) {
