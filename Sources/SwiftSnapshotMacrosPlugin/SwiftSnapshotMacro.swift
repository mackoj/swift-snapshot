...
public struct SwiftSnapshotMacro: MemberMacro, ExtensionMacro {
  public static func expansion(
    ...
    if isEnum {
      members.append(try generateEnumExpressionBuilder(from: declaration, properties: properties, context: context))
    } else {
      members.append(try generateStructExpressionBuilder(from: declaration, properties: properties, context: context))
    }
...
extension SwiftSnapshotMacro {
  ...
  static func collectProperties(from declaration: some DeclGroupSyntax, context: some MacroExpansionContext) -> [PropertyInfo] {
    ...
    for member in members {
      ...
      for binding in varDecl.bindings {
        ...
        for attribute in varDecl.attributes {
          ...
          guard let identifierType = attr.attributeName.as(IdentifierTypeSyntax.self) else { continue }
  ...
  static func extractRedactionArguments(from attribute: AttributeSyntax, context: some MacroExpansionContext) -> RedactionInfo? {
