...
//        LiteralConfig.setFormattingProfile(FormatProfile())
//        LiteralConfig.setRenderOptions(RenderOptions())
//    }
//
...
//        measure {
//            do {
//                let _ = try Literal.generateSwiftCode(
//                    instance: largeArray,
...
//        let startTime = Date()
//
//        let code = try Literal.generateSwiftCode(
//            instance: largeArray,
//            variableName: "largeArray"
//        )
//
